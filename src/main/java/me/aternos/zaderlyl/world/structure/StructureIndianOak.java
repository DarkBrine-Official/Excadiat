...
package me.aternos.zaderlyl.world.structure;
...
public class StructureIndianOak extends ElementsZaderMod.ModElement {
	public StructureIndianOak(ElementsZaderMod instance) {
		super(instance, 18);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 1000000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("zadermod", "indiana_oak1"));
				if (template == null)
					return;
