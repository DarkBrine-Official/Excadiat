...
package me.aternos.zaderlyl.world;
...
import me.aternos.zaderlyl.item.ItemNetherium;
import me.aternos.zaderlyl.block.BlockNetheriumArk;
...
public class WorldNetherium extends ElementsZaderMod.ModElement {
	public static int DIMID = 3;
	public static final boolean NETHER_TYPE = true;
	@GameRegistry.ObjectHolder("zadermod:netherium_portal")
	public static final BlockCustomPortal portal = null;
	public static DimensionType dtype;
	public WorldNetherium(ElementsZaderMod instance) {
		super(instance, 21);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ItemNetherium().setUnlocalizedName("netherium").setRegistryName("netherium"));
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension netherium is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("netherium", "_netherium", DIMID, WorldProviderMod.class, true);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(ItemNetherium.block, 0, new ModelResourceLocation("zadermod:netherium", "inventory"));
	}
	public static class WorldProviderMod extends WorldProvider {
		...
		public Vec3d getFogColor(float par1, float par2) {
			return new Vec3d(0.141176470588, 0.443137254902, 0.521568627451);
		}
					...
					for (int l7 = 1; l7 < 3; ++l7) {
						for (int k8 = -1; k8 < 3; ++k8) {
							...
							this.world.setBlockState(new BlockPos(k9, k10, k11),
									flag ? Blocks.AIR.getDefaultState().getBlock().getDefaultState() : Blocks.AIR.getDefaultState());
						}
					}
				}
			}
				...
				for (int l8 = 0; l8 < 4; ++l8) {
					for (int l9 = -1; l9 < 4; ++l9) {
						...
						this.world.setBlockState(new BlockPos(l10, l11, k12),
								flag1 ? Blocks.AIR.getDefaultState().getBlock().getDefaultState() : iblockstate, 2);
					}
				}
	...
	public static class BlockCustomPortal extends BlockPortal {
		public BlockCustomPortal() {
			setHardness(-1.0F);
			setUnlocalizedName("netherium_portal");
			setRegistryName("netherium_portal");
			setLightLevel(0F);
		}
		...
		public static class Size {
			...
			protected int getDistanceUntilEdge(BlockPos p_180120_1_, EnumFacing p_180120_2_) {
				...
				for (i = 0; i < 22; ++i) {
					...
					if (!this.isEmptyBlock(this.world.getBlockState(blockpos).getBlock())
							|| this.world.getBlockState(blockpos.down()).getBlock() != Blocks.AIR.getDefaultState().getBlock()) {
						break;
					}
				}
				Block block = this.world.getBlockState(p_180120_1_.offset(p_180120_2_, i)).getBlock();
				return block == Blocks.AIR.getDefaultState().getBlock() ? i : 0;
			}
			...
			protected int calculatePortalHeight() {
				label56 : for (this.height = 0; this.height < 21; ++this.height) {
					for (int i = 0; i < this.width; ++i) {
						...
						if (i == 0) {
							...
							if (block != Blocks.AIR.getDefaultState().getBlock()) {
								break label56;
							}
				...
				for (int j = 0; j < this.width; ++j) {
					if (this.world.getBlockState(this.bottomLeft.offset(this.rightDir, j).up(this.height)).getBlock() != Blocks.AIR.getDefaultState()
							.getBlock()) {
						this.height = 0;
						break;
					}
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		private static final IBlockState STONE = BlockNetheriumArk.block.getDefaultState();
		private static final IBlockState STONE2 = Blocks.STONE.getStateFromMeta(6);
		private static final IBlockState STONE3 = Blocks.GOLD_BLOCK.getDefaultState();
